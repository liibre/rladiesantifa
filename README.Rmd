...
For the hexsticker we use the ANTIFA flag we use the public domain icon from [The Noun Project](https://thenounproject.com/search/?q=antifa&i=1245689). The function `antifa()` creates the flag with the desired title.
...
sticker(~ antifa(bg.col = rladies, text.size = 3.5),
        package = "",
        s_x = .7, s_y = .7,
        s_width = 3.5, s_height = 3.5,
        p_size = 13,
...
sticker(~ antifa(bg.col = "#88398A", text.size = 3.5),
        package = "",
        s_x = .7, s_y = .7,
        s_width = 3.5, s_height = 3.5,
        p_size = 13,
